...
# (The original) Demeter Discord Bot
...
- twitter-access-token: Token to access the Twitter account that will have to be generated by someone having access to the Twitter account
- twitter-refresh-token: Token allowing to get a new access token after its expiration. It must also be generated by someone having access to the Twitter account. 
- twitter-oauth2-client-id: Oauth2 client id used to authenticate against Twitter API v2 
- twitter-oauth2-client-secret: Oauth2 client secret used to authenticate against Twitter API v2
...
Don't forget to set `ENCRYPTION_KEY` environment variable.
