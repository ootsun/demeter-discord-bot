...
export interface CounterTestInterface extends utils.Interface {
  functions: {
    ...
    "testIncrement()": FunctionFragment;
    "testSetNumber(uint256)": FunctionFragment;
  };
...
export interface CounterTest extends BaseContract {
  ...
  callStatic: {
    ...
    testIncrement(overrides?: CallOverrides): Promise<void>;

    testSetNumber(x: BigNumberish, overrides?: CallOverrides): Promise<void>;
  };
